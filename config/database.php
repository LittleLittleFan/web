...
return [
    ...
    */
    ...
    'redis' => [
        ...
        // 腾讯云redis作为自增序列生成器
        'increment_generator' => [
            'host'     => env('REDIS_INCREMENT_GENERATOR_HOST', '127.0.0.1'),
            'port'     => env('REDIS_INCREMENT_GENERATOR_PORT', 6379),
            'password' => env('REDIS_INCREMENT_GENERATOR_PASSWORD', null),
            'database' => env('REDIS_INCREMENT_GENERATOR_DATABASE', 0),
        ],
        //session redis
        'redis_session' => [
